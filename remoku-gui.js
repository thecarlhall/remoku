...
var remokuVarNames = "rokuAddress manualRokus namedRokus scannedRokus myNetwork rokuCount macros showFavs fav1 fav2 fav3 favsList bgColor fgColor".split(" ");
...
function setupFavs(){
	...
	if (favsList.length>0 && rokuAddress) document.getElementById('fav-' + favsList[0]).src = "http://" + rokuAddress + ":8060/query/icon/" + favsList[0];
}
